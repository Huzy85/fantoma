...
|----------|--------|-----------|
| LLM for agent | Both local-coder (local) and Claude Sonnet (cloud) | Local score proves vendor independence, Sonnet score competes on the leaderboard |
...
|-------|-----|-------|-----------|----------|
| **Fantoma 0.7.0** | **local-coder (local 32B)** | **XX.X%** | **X.X** | **XXs** |
