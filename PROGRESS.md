...
Spatial detection of dropdown suggestions near focused input. Clicks best text match. Proven on Rightmove ("a postcode" exact match) and Booking.com ("a UK town").
